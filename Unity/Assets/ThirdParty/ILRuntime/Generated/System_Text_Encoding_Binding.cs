...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Text_Encoding_Binding
    {
        ...
        static StackObject* GetBytes_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Text.Encoding instance_of_this_method;
            instance_of_this_method = (System.Text.Encoding)typeof(System.Text.Encoding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
