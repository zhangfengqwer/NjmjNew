...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Security_Cryptography_HashAlgorithm_Binding
    {
        ...
        static StackObject* ComputeHash_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Security.Cryptography.HashAlgorithm instance_of_this_method;
            instance_of_this_method = (System.Security.Cryptography.HashAlgorithm)typeof(System.Security.Cryptography.HashAlgorithm).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
