...
{
    unsafe class ETModel_M2C_Reload_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.M2C_Reload);
            args = new Type[]{};
        ...
        static StackObject* get_Error_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.M2C_Reload instance_of_this_method = (ETModel.M2C_Reload)typeof(ETModel.M2C_Reload).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
