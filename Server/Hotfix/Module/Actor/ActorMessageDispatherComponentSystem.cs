    ...
    public static class ActorMessageDispatherComponentEx
    {
        ...
        public static void Load(this ActorMessageDispatherComponent self)
        {
            ...
            foreach (Type type in types)
            {
                ...
                {
                    throw new Exception(
                        $"message handler not inherit IMActorHandler abstract class: {obj.GetType().FullName}");
                }
        ...
        public static async Task ActorTypeHandle(
            this ActorMessageDispatherComponent self, string actorType, Entity entity,
            ActorMessageInfo actorMessageInfo)
        {
        ...
        /// </summary>
        public static async Task Handle(this ActorMessageDispatherComponent self, Session session, Entity entity,
            IActorMessage actorRequest)
        {
