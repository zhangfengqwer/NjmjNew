...
{
    [ObjectSystem]
    public class DBQueryJsonPlayerInfoTaskAwakeSystem:AwakeSystem<DBQueryPlayerInfoJsonTask,string,string,TaskCompletionSource<List<PlayerBaseInfo>>>
    {
        public override void Awake(DBQueryPlayerInfoJsonTask self, string collectionName, string json, TaskCompletionSource<List<PlayerBaseInfo>> tcs)
        {
    ...
    public sealed class DBQueryPlayerInfoJsonTask : DBTask
    {
